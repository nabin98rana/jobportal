...
class EmployeeRegistrationForm(UserCreationForm):
    """docstring for EmployeeRegistrationForm."""
...
class EmployerRegistration(UserCreationForm):
    """docstring for EmployerRegistration."""

    def __init__(self, *args, **kwargs):
        super(EmployerRegistration, self).__init__(*args, **kwargs)
...
class EmployeeProfileUpdateForm(forms.ModelForm):
    """docstring for EmployeeProfileUpdateForm."""
